...
{ id:"neck-rotations", name:"Neck rotations", cats:["thoracic"], fatigue:"low", level:1,
  targets:"Neck mobility, circling the head through a full comfortable range.",
  why:"A standard warm-up opener before anything that loads the shoulders and upper back — the neck is part of the same kinetic chain and rarely gets its own dedicated warm-up movement.",
  when:["before"], dosage:"10 rotations each direction.",
  progression:"Slightly increase the range as the neck warms up.",
  regression:"Smaller, gentler circles, especially first thing in the morning.",
  mistakes:"Forcing the range instead of staying within a comfortable, pain-free arc; moving too fast to actually feel the motion.",
  cues:"Move slowly and smoothly — this is a warm-up, not a stretch to chase depth on.",
  pairs:"A natural first movement before shoulder rolls and arm circles.",
  source:"Standard neck mobility warm-up; consistent, low-disagreement technique across general warm-up guides.",
  upgrades:[
    {type:"measurable", label:"Log any tension side", detail:"Note if one direction feels tighter — useful context for the rest of the warm-up."},
    {type:"harder", label:"Add a brief pause", detail:"A short pause at the back of the circle adds a small extension-hold component."},
  ],
  media:[
    {t:"article",label:"Warm-ups and Cool-downs", src:"U.S. Army Holistic Health & Fitness", url:"https://h2f.army.mil/Portals/141/pdfs/physical/Warm%20Ups%20and%20Cool%20Downs.pdf"},
  ]},

{ id:"shoulder-rolls", name:"Shoulder rolls", cats:["scap"], fatigue:"low", level:1,
  targets:"Shoulder joint and scapular warmth, rolling the shoulders in a circular shrug pattern with the arms hanging relaxed.",
  ...
  source:"Cross-checked against BODi's shoulder warm-up guidance, which specifically names shoulder rolls (distinct from arm circles) as a standard pre-training opener.",
  upgrades:[
    {type:"measurable", label:"Log range comfort", detail:"Note how loose the shoulders feel after — a rough, subjective but useful marker."},
    {type:"harder", label:"Add resistance", detail:"Light hand weights add a small load through the same circular pattern."},
  ],
  media:[
    {t:"article",label:"The 5 Best Dumbbell Shoulder Exercises", src:"Peloton", url:"https://www.onepeloton.com/blog/dumbbell-shoulder-exercises"},
  ]},

{ id:"wide-forward-fold", name:"Wide-legged standing forward fold", cats:["hips"], fatigue:"low", level:1,
  targets:"Hamstrings, inner thighs and spine, folding forward from a wide standing stance.",
  why:"A deeper, wider version of a standard forward fold — the wide stance changes the stretch angle through the inner thighs as well as the hamstrings, useful groundwork for straddle-dependent skills.",
  when:["before","recovery"], dosage:"3 × 30-45 s.",
  progression:"Walk the hands further back between the feet, working toward fingers level with the heels.",
  regression:"Keep a slight bend in the knees, and don't chase depth — width matters more than how low you fold.",
  mistakes:"Rounding hard through the back to force depth instead of hinging cleanly from the hips.",
  cues:"Press through all four corners of each foot, engage the thighs, and fold from the hip crease, not the waist.",
  pairs:"A good addition alongside pike fold and butterfly stretch — all three train overlapping hamstring and inner-thigh range.",
  source:"Standard yoga posture (Prasarita Padottanasana), cross-checked against EverydayYoga and Yoga Journal — technique is consistent with no meaningful disagreement.",
  upgrades:[
    {type:"measurable", label:"Log hand position", detail:"Track how far your hands walk back — toward the heels is real progress."},
    {type:"harder", label:"Narrow the stance slightly", detail:"A narrower stance shifts more of the load onto the hamstrings specifically."},
  ],
  media:[
    {t:"article",label:"How to Do Wide-Legged Standing Forward Fold in Yoga", src:"EverydayYoga.com", url:"https://www.everydayyoga.com/blogs/guides/how-to-do-wide-legged-standing-forward-fold-in-yoga"},
    {t:"article",label:"Wide-Legged Standing Forward Bend", src:"Yoga Journal", url:"https://www.yogajournal.com/poses/wide-legged-forward-bend/"},
  ]},

{ id:"kneeling-chest-floor", name:"Kneeling chest-to-floor with finger press", cats:["thoracic","overhead"], fatigue:"low", level:1,
  targets:"Shoulders, lats and thoracic spine, kneeling with the chest reached toward the floor and the fingertips actively pressing down.",
  why:"A more active variant of a resting child's pose — the active finger press adds a small forearm and finger-strength component relevant to handstand finger control, on top of the usual shoulder opening.",
  when:["before","recovery"], dosage:"3 × 30-45 s.",
  progression:"Walk the hands further forward, and increase how hard the fingertips press into the floor.",
  regression:"Rest the hands flat rather than pressing through the fingertips, and keep the reach shorter.",
  mistakes:"Letting the hips drift back off the heels, which turns this into a different stretch entirely.",
  cues:"Sit back toward your heels, reach your arms forward, and actively spread and press your fingertips into the floor rather than just resting your hands there.",
  pairs:"A natural pairing with your puppy pose variations — same shoulder-opening role, different active component.",
  source:"Variant of the standard child's pose family; the active finger-press detail is a reasonable, low-risk addition consistent with general finger and forearm activation principles used elsewhere in hand-balancing prep.",
  upgrades:[
    {type:"measurable", label:"Log press intensity", detail:"Note how hard you're able to press through the fingertips without discomfort."},
    {type:"harder", label:"Walk the hands further", detail:"A longer reach increases the shoulder stretch component."},
  ],
  media:[
    {t:"article",label:"Puppy Pose — technique and variations", src:"Dani Winks Flexibility", url:"https://www.daniwinksflexibility.com/flexopedia/puppy-pose"},
  ]},

{ id:"prone-iyt-raises", name:"Prone I-Y-T raises", cats:["scap"], fatigue:"low", level:2,
  targets:"Rear delts, mid and lower traps, and rotator cuff, lying face down and raising straight arms through three angles — overhead (I), diagonal (Y), and out to the sides (T).",
  why:"A genuine scapular-strengthening exercise, not just a stretch — this trains the exact muscles that stabilize the shoulder blade through the overhead range your handstand work constantly demands.",
  when:["before","skill"], dosage:"10 reps at each angle (I, Y, T).",
  progression:"Add very light dumbbells once bodyweight reps feel controlled and easy.",
  regression:"Smaller range at each angle, and rest the forehead on a folded towel for neck comfort.",
  mistakes:"Using the lower back to throw the arms up instead of moving from the shoulder blades; shrugging the shoulders up toward the ears at the top.",
  cues:"Keep your thumbs turned up throughout each angle. Lift only a few inches — the range is small on purpose. Squeeze the shoulder blades together at the top of each rep.",
  pairs:"A strong pairing with wall angels and scapular push-ups — all train scapular control from different angles.",
  source:"Cross-checked across FitCraft's dedicated I/Y/T raise guides and ACE Fitness's Prone Scapular Stabilization Series — consistent on the thumbs-up cue and the small, controlled range.",
  upgrades:[
    {type:"measurable", label:"Log reps at each angle without compensation", detail:"Track how many clean reps you get before the lower back starts helping."},
    {type:"harder", label:"Add light dumbbells", detail:"Very light weight (1-2 lbs) adds real resistance to an otherwise bodyweight-only movement."},
  ],
  media:[
    {t:"article",label:"How to Do Prone Y Raises", src:"FitCraft", url:"https://getfitcraft.com/exercises/y-raise"},
    {t:"article",label:"How to Do Prone T Raises", src:"FitCraft", url:"https://getfitcraft.com/exercises/t-raise"},
    {t:"article",label:"Prone Scapular Stabilization Series — I, Y, T, W, O", src:"ACE Fitness", url:"https://www.acefitness.org/resources/everyone/exercise-library/249/prone-scapular-shoulder-stabilization-series-i-y-t-w-o-formation/"},
  ]},

{ id:"band-facepull-press", name:"Band face pull to overhead press", cats:["scap","overhead"], fatigue:"low", level:2,
  targets:"Rear delts and rotator cuff together with overhead pressing strength, pulling a band back into a face pull then driving it overhead into a press.",
  why:"A combined complex rather than two separate exercises — pulling into external rotation and then pressing overhead in one continuous movement trains the exact transition your shoulders make going into an overhead position, not just the two ends of it in isolation.",
  when:["before","skill"], dosage:"2-3 × 8 each side.",
  progression:"Use a stronger band, or slow the whole sequence down for more time under tension.",
  regression:"Lighter band, and treat the two halves as separate movements at first if the combination feels too complex.",
  mistakes:"Rushing the transition from pull to press, which loses the external rotation that makes this movement valuable in the first place.",
  cues:"Pull the band back into a face pull first, elbows high. At the top of the pull, rotate and drive the hand overhead into a full press.",
  pairs:"A natural progression once band pull-aparts and face pulls feel easy on their own.",
  source:"Cross-checked against Tom's Guide's coverage of this exact combined movement (there described two-handed as 'face pull x external rotation to press'), adapted here as the single-arm version described in class.",
  upgrades:[
    {type:"measurable", label:"Log the band strength", detail:"Track resistance level and progress it as the transition feels smoother."},
    {type:"harder", label:"Slow the tempo", detail:"A 3-second count through the whole pull-to-press sequence adds real time under tension."},
  ],
  media:[
    {t:"article",label:"4 moves to strengthen your shoulders and boost upper body mobility", src:"Tom's Guide", url:"https://www.tomsguide.com/wellness/fitness/strength-and-conditioning-coach-reveals-4-moves-to-strengthen-your-shoulders-and-boost-upper-body-mobility"},
  ]},

{ id:"wall-pike-push", name:"Wall pike push", cats:["compression","overhead"], fatigue:"med", level:2,
  targets:"Hip flexors, hamstrings and shoulders together, feet braced against a wall while actively pushing through a pike compression position.",
  why:"A wall-assisted version of the same pike-compression work your seated pike lifts and straddle liftoffs already train — the wall gives extra leverage to push against, letting you load the compression harder than an unsupported floor version.",
  when:["skill"], dosage:"3 rounds.",
  progression:"Move the hands further from the wall for a longer lever, or slow the push phase.",
  regression:"Move the hands closer to the wall, shortening the lever and the demand.",
  mistakes:"Letting the shoulders round forward instead of staying reached toward the ears — the shoulder position matters as much as the leg compression here.",
  cues:"Press your feet into the wall while pushing through your hands, straightening the knees and reaching your shoulders up toward your ears, like the shoulder position in your press handstand work.",
  pairs:"A direct complement to seated pike lifts and straddle liftoffs — same compression goal, different loading angle.",
  source:"Wall-assisted variant of standard pike compression work, in the same family as GMB's wall-supported handstand press drills, which use the wall specifically to add controlled resistance to end-range positions.",
  upgrades:[
    {type:"measurable", label:"Log hand distance from the wall", detail:"Track how far your hands are from the wall as the lever length increases."},
    {type:"harder", label:"Move the hands out further", detail:"A longer lever increases the compression demand significantly."},
  ],
  media:[
    {t:"article",label:"2 Handstand Press Drills You Can Do at the Wall", src:"Yoga International", url:"https://yogainternational.com/article/view/2-handstand-press-drills-you-can-do-at-the-wall/"},
  ]},

{ id:"weighted-pullover-stretch", name:"Weighted overhead pullover stretch", cats:["overhead","flexion"], fatigue:"low", level:2,
  targets:"Shoulder flexion range and lats, lying on the floor with light dumbbells, letting gravity pull the arms overhead into a stretch.",
  why:"A loaded, passive-into-active shoulder-flexion stretch — the light weight lets gravity do more of the work than a bodyweight-only stretch, and elevating the shoulder blades on a block increases the range further, exactly the kind of end-range work your overhead line depends on.",
  when:["skill","recovery"], dosage:"20 s hold.",
  progression:"Add a small block or step under the shoulder blades to increase the range, matching how a bench increases range in the seated version of this drill.",
  regression:"Use lighter weight, or skip the block and stay flat on the floor.",
  mistakes:"Using weight that's too heavy, which pulls the lower back into an arch instead of isolating the shoulder stretch — keep it light, this is a stretch, not a strength exercise.",
  cues:"Lie on your back, knees bent, feet flat. Hold a light dumbbell in each hand, arms straight, and let them reach back overhead until you feel a genuine stretch, keeping the lower back flat against the floor.",
  pairs:"A loaded complement to your regular overhead lat stretch — this one uses gravity and light load instead of a static hold.",
  source:"Cross-checked against E3 Rehab's shoulder range-of-motion progression, which specifically names this the 'Weighted Single Arm Pullover from the Floor' and describes the same block-elevation progression to increase range.",
  upgrades:[
    {type:"measurable", label:"Log the block height used", detail:"Track whether you're flat on the floor or elevated, and how high, as range improves."},
    {type:"harder", label:"Add the block", detail:"Elevating the shoulder blades increases the stretch range significantly — the direct next progression."},
  ],
  media:[
    {t:"article",label:"How to Improve Your Shoulder Range of Motion", src:"E3 Rehab", url:"https://e3rehab.com/shoulder-range-of-motion/"},
  ]},

{ id:"loaded-hollow-extension", name:"Loaded hollow extension", cats:["compression","rib"], fatigue:"med", level:3,
  targets:"Core, shoulders and hip flexors together, extending from a tucked position to a full hollow shape while holding light dumbbells, on an elevated box or bench.",
  why:"A loaded, elevated variant of your existing hollow body work — the light dumbbells and the extra range from being on a box add real difficulty to a position you already train, useful strength carryover for anything demanding a rigid extended line under load.",
  when:["skill"], dosage:"3 × 6, holding 2 s at full extension.",
  progression:"Use slightly heavier dumbbells, or extend the hold at full length.",
  regression:"No added weight at first — master the bodyweight box version before loading it.",
  mistakes:"Letting the lower back arch off the surface as the arms and legs extend — the hollow shape needs to hold throughout the whole extension, not just at the tucked start.",
  cues:"Start tucked, knees and arms in tight. Extend both arms and legs away from your body at the same time, keeping your lower back pressed into the surface throughout. Hold briefly at full length, then return to the tuck.",
  pairs:"A natural progression once your standard hollow body hold and hollow rocks feel genuinely easy.",
  source:"A loaded, elevated variant of standard hollow-body extension training principles; the box elevation and light dumbbell loading follow the same progressive-overload logic used across other compression and hollow-body progressions.",
  upgrades:[
    {type:"measurable", label:"Log the load and hold time", detail:"Track dumbbell weight and hold duration at full extension as both increase."},
    {type:"harder", label:"Add weight or extend the hold", detail:"Either dimension adds real difficulty once the base movement is solid."},
  ],
  media:[
    {t:"article",label:"35 Best Flexibility Exercises", src:"Pliability", url:"https://pliability.com/stories/flexibility-exercises"},
  ]},
...
{ id:"fingertip-plank", name:"Fingertip plank", cats:["wrist"], fatigue:"low", level:3,
  targets:"Finger and forearm strength, holding a plank supported on the fingertips instead of the full palm.",
  why:"A genuinely more advanced isolation of the same finger strength your wrist prep only briefly touches — direct carryover to the finger control that fine-tunes balance in a freestanding handstand.",
  when:["before","skill"], dosage:"3 × as long as form holds, building toward 15-20 s.",
  progression:"Extend hold time, or reduce how many fingers are in contact with the floor.",
  regression:"Support more of the load through the palm at first, gradually shifting weight onto the fingertips as strength builds.",
  mistakes:"Letting the fingers collapse flat under load instead of staying curled and rigid; holding the breath instead of breathing normally.",
  cues:"Spread your fingers and press each fingertip down actively, keeping the first knuckle joint from collapsing. Stop the moment form breaks down rather than grinding through.",
  pairs:"A natural progression once your regular wrist prep and reverse wrist push-ups feel comfortable and well-established.",
  source:"Standard finger-strength progression used broadly in hand-balancing and gymnastics conditioning; the fingertip-versus-palm loading principle is consistent across sources.",
  upgrades:[
    {type:"measurable", label:"Log hold time", detail:"Track how long you can hold with genuinely rigid fingers before they start to collapse."},
    {type:"harder", label:"Reduce finger count", detail:"Fewer fingers in contact increases the load on each one significantly."},
  ],
  media:[
    {t:"article",label:"35 Best Flexibility Exercises", src:"Pliability", url:"https://pliability.com/stories/flexibility-exercises"},
  ]},

{ id:"straddle-plank", name:"Straddle plank", cats:["compression","line"], fatigue:"med", level:2,
  targets:"Shoulders, core and inner thighs together, holding a front-support plank with the legs opened wide into a straddle.",
  why:"Combines your regular plank's shoulder and core demand with the same straddle-width hip position your straddle press and straddle-dependent skills need — genuinely efficient double-duty conditioning.",
  when:["skill"], dosage:"3 × 20 s.",
  progression:"Widen the straddle further, or elevate the hands on parallettes for more shoulder range.",
  regression:"A narrower straddle, or drop to the knees while keeping the straddle width.",
  mistakes:"Letting the hips sag as the legs widen — the core still has to do the same job a regular plank asks of it, just with a wider, less stable base.",
  cues:"Set up in a standard front-support plank, then walk the feet out wide into a straddle. Keep the hips level and the shoulders stacked over the hands throughout.",
  pairs:"A natural pairing with your existing straddle press work and pancake stretch — same width demand, different loading angle.",
  source:"A straddle-width variant of standard front-support plank conditioning; the combined shoulder-stability-plus-hip-width demand is consistent with how straddle work is trained across hand-balancing sources.",
  upgrades:[
    {type:"measurable", label:"Log the straddle width and hold time", detail:"Track how wide a straddle you can hold with the hips staying level."},
    {type:"harder", label:"Elevate the hands", detail:"Parallettes or blocks under the hands add shoulder range and difficulty."},
  ],
  media:[
    {t:"article",label:"35 Best Flexibility Exercises", src:"Pliability", url:"https://pliability.com/stories/flexibility-exercises"},
  ]},

{ id:"stallbar-pike-hollow", name:"Stall bar pike to hollow", cats:["compression","line"], fatigue:"med", level:2,
  targets:"Shoulders and compression together, hands fixed on a stall bar or wall-mounted support, moving between a pike stretch and a hollow press position.",
  why:"The stall bar (or a wall used the same way) gives a fixed anchor point that a normal pike or hollow drill on the floor can't — letting you actively push through a genuinely deeper compressed range than bodyweight alone allows.",
  when:["skill"], dosage:"2 × 8.",
  progression:"Increase how far you push into each end of the range, or slow the transition between pike and hollow.",
  regression:"Use a lower bar height, or reduce the range at each end.",
  mistakes:"Letting the back round instead of staying neutral during the pike-stretch phase — the point is a controlled stretch, not spinal flexion.",
  cues:"With hands fixed on the bar or wall, push your chest down into a pike stretch with a neutral back, then reverse and push up into a hollow shape, feeling the compression through your whole line.",
  pairs:"A natural pairing with your existing straddle liftoffs and seated pike lifts — same compression goal, different anchor point.",
  source:"Cross-checked against Vahva Fitness's stall bar mobility guide and stall-bar press-handstand coaching content — both confirm stall bars are specifically used this way for shoulder and compression work ahead of press handstand training.",
  upgrades:[
    {type:"measurable", label:"Log range at each end", detail:"Track how deep the pike stretch goes and how compressed the hollow position gets."},
    {type:"harder", label:"Slow the transition", detail:"A slower, more controlled move between the two ends adds real time under tension."},
  ],
  media:[
    {t:"video", label:"Stall Bar Exercises for Compression and Press Handstand", src:"YouTube", url:"https://www.youtube.com/watch?v=7XiRYlOpi0A"},
    {t:"article",label:"Stall Bar Exercises for Mobility and Flexibility", src:"Vahva Fitness", url:"http://vahvafitness.com/stall-bar-exercises-mobility-flexibility/"},
  ]},

{ id:"hollow-activation", name:"Hollow body activation", cats:["rib"], fatigue:"low", level:1,
  targets:"Teaches the transition from a neutral lying position into an active hollow shape, using the abs to close the gap under the lower back.",
  why:"The entry-level teaching drill your static hollow body hold is built on — rather than holding the shape, this specifically trains the transition into it, useful any time the hollow position needs re-grooving from scratch.",
  when:["before","skill"], dosage:"3 × 10.",
  progression:"Once the transition feels automatic, hold the closed position for 2-3 seconds before releasing back to neutral.",
  regression:"A smaller range — just enough to feel the abs actively closing the gap, not a big dramatic movement.",
  mistakes:"Using the hip flexors to yank the pelvis into position instead of the abs actively flattening the lower back.",
  cues:"Start relaxed, feeling the natural gap under your lower back. Exhale and use your abs to press that gap flat against the floor — that's the same activation your full hollow hold depends on.",
  pairs:"A natural warm-up before hollow body hold or hollow rocks — teaches the activation those drills assume you already have.",
  source:"Standard hollow-body teaching progression used broadly in gymnastics and calisthenics coaching — the neutral-to-active transition is consistently taught as the foundational entry point before a sustained hold.",
  upgrades:[
    {type:"measurable", label:"Log how quickly the activation happens", detail:"Track whether the transition feels instant and automatic or still requires conscious effort."},
    {type:"harder", label:"Add a hold", detail:"Once the transition is automatic, hold the closed position briefly before releasing."},
  ],
  media:[
    {t:"article",label:"How To Do Hollow Body Rocks", src:"Calixpert", url:"https://www.calixpert.com/exercises/hollow-body-rocks"},
  ]},

{ id:"stallbar-hollow-kicks", name:"Stall bar hollow kicks", cats:["line","rib"], fatigue:"med", level:3,
  targets:"Hollow-position control under real disruption, holding an active hollow shape on a stall bar while kicking one leg at a time.",
  why:"A genuine test of whether your hollow position actually holds under a disruptive load, not just in a static hold — directly relevant to maintaining shape during a real handstand kick-up or entry.",
  when:["skill"], dosage:"2 × 10 each leg.",
  progression:"Kick with more speed or a bigger range while keeping the hollow position from breaking.",
  regression:"Smaller, slower kicks, focusing purely on keeping the hollow shape intact.",
  mistakes:"Letting the hollow position collapse the moment the kicking leg moves — the whole point is keeping the shape solid despite the disruption, not just doing a leg raise.",
  cues:"Set your hollow position on the bar first, and hold it. Kick one leg without letting anything else in your body shape change. If the hollow breaks, reset before continuing.",
  pairs:"A natural progression once stall bar pike to hollow and your regular hollow body hold both feel solid.",
  source:"Standard hand-balancing conditioning principle — testing a trained position's integrity under a disruptive load (here, a kicking leg) is a common progression once the static version of a position is solid.",
  upgrades:[
    {type:"measurable", label:"Log kicks before the hollow breaks", detail:"Track how many kicks you get through before the position starts to lose integrity."},
    {type:"harder", label:"Increase kick speed", detail:"A faster kick is a bigger disruption to control against."},
  ],
  media:[
    {t:"video", label:"Stall Bar Exercises for Compression and Press Handstand", src:"YouTube", url:"https://www.youtube.com/watch?v=7XiRYlOpi0A"},
  ]},

{ id:"weighted-shrugs", name:"Weighted standing shrugs", cats:["scap"], fatigue:"low", level:2,
  targets:"Upper traps and scapular elevation, shrugging the shoulders straight up while holding a weight plate or dumbbells.",
  ...
  source:"Standard loaded shrug exercise; technique (straight vertical shrug, no rolling) is universal and low-disagreement across strength coaching sources.",
  upgrades:[
    {type:"measurable", label:"Log the weight used", detail:"Track load and progress it as scapular strength improves."},
    {type:"harder", label:"Add a pause", detail:"A 1-2 second hold at the top of each shrug adds real time under tension."},
  ],
  media:[
    {t:"article",label:"25 Best Upper Body Warm Up Exercises", src:"Pliability", url:"https://pliability.com/stories/upper-body-warm-up-exercises"},
  ]},

{ id:"hollow-rocks", name:"Hollow rocks", cats:["rib"], fatigue:"med", level:2,
  targets:"Anterior chain and anti-extension core control, rocking gently back and forth while holding a hollow body shape.",
  why:"Genuinely distinct from your static hollow body hold — the rocking motion forces the hollow shape to hold its integrity under continuous movement, which is a much closer match to how core control actually gets tested during real skill work.",
  when:["skill"], dosage:"2 × 15-20.",
  progression:"Increase the rocking range slightly, or add light ankle weights.",
  regression:"Bend the knees to shorten the lever, reducing the demand significantly.",
  mistakes:"Losing hollow-shape tension during the rock — there should be no visible \\u201cclunk\\u201d or flat spot in the rocking motion; that clunk is a sign of a weak spot in the position, not just a normal part of the movement.",
  cues:"Set your hollow position first, then gently shift your weight toward your shoulders and back toward your legs. Keep the rock small and smooth — smoothness matters more than range.",
  pairs:"A natural progression once your static hollow body hold feels genuinely solid — same shape, added movement demand.",
  source:"Cross-checked across BarBend, Horton Barbell, and Calixpert's hollow rock guides — all consistent on keeping the rocking range controlled and small, and on the \\u201csmooth rock, no clunk\\u201d quality marker.",
  upgrades:[
    {type:"measurable", label:"Log reps without a clunk", detail:"Track how many smooth, controlled rocks you get before the position starts to break down."},
    {type:"harder", label:"Add ankle weights", detail:"Light weight on the legs increases the lever and the core demand significantly."},
  ],
  media:[
    {t:"article",label:"Hollow Rocks (Complete How To Guide w/ Video)", src:"Horton Barbell", url:"https://hortonbarbell.com/hollow-rocks/"},
    {t:"article",label:"How To Do Hollow Body Rocks", src:"Calixpert", url:"https://www.calixpert.com/exercises/hollow-body-rocks"},
  ]},

{ id:"wall-straddle-open", name:"Wall to straddle open", cats:["line"], fatigue:"high", level:3,
  targets:"The transition from wall-supported balance to freestanding, opening from a wall-facing handstand into a straddle before leaving the wall entirely.",
  why:"A genuine bridge drill between wall practice and freestanding balance — opening the legs into a straddle changes your center of mass in a way that forces real balance adjustment before you commit to leaving the wall.",
  when:["skill"], dosage:"4 attempts.",
  progression:"Hold the freestanding straddle position longer before it breaks, or bring the legs together sooner after leaving the wall.",
  regression:"Stay wall-facing longer before attempting to open and leave, or keep a spotter nearby.",
  mistakes:"Opening the straddle too fast or too wide, which overcorrects the balance point rather than smoothly shifting it.",
  cues:"Kick up wall-facing, find your balance, then gradually open your legs into a straddle while feeling how your balance point shifts. Push away from the wall only once that shift feels controlled.",
  pairs:"A natural progression once your regular kick-up practice and wall-facing holds both feel consistent.",
  source:"Standard progression concept in hand-balancing — using a straddle-open transition as a controlled bridge between wall-assisted and freestanding balance is a widely used coaching approach.",
  upgrades:[
    {type:"measurable", label:"Log how long you hold freestanding after opening", detail:"Track the freestanding duration after leaving the wall as your real balance marker."},
    {type:"harder", label:"Leave the wall sooner", detail:"Reducing how long you stay wall-facing before opening increases the balance demand."},
  ],
  media:[
    {t:"article",label:"31 Best Handstand Drills and Progressions", src:"Balance Addicts", url:"https://balanceaddicts.com/blogs/handstands/handstand-drills-for-beginners"},
  ]},

{ id:"childspose-handsback", name:"Child's pose, hands back", cats:["thoracic","overhead"], fatigue:"low", level:1,
  targets:"Shoulders through a different angle than the standard forward-reaching child's pose, hands relaxed alongside the body reaching back toward the feet.",
  why:"A genuinely different stretch angle from your existing kneeling chest-to-floor variant — reaching the arms back instead of forward changes which part of the shoulder gets the emphasis.",
  when:["recovery"], dosage:"3 × 30-45 s.",
  progression:"Let the shoulders relax deeper into the position as it becomes more familiar.",
  regression:"Rest on a bolster or cushion under the chest for support.",
  mistakes:"Tensing the shoulders instead of letting them fully relax — this variation depends on passive relaxation, not active reaching.",
  cues:"Sit back toward your heels, chest and forehead resting toward the floor, and let your arms rest passively alongside your body, palms facing up, reaching gently back toward your feet.",
  pairs:"A natural pairing with your forward-reaching child's pose variant — together they cover the shoulder from two different angles.",
  source:"A recognized variant of the standard child's pose family, commonly used in yoga and mobility sequencing as a passive shoulder-relaxation counterpart to the forward-reaching version.",
  upgrades:[
    {type:"measurable", label:"Log how relaxed the shoulders feel", detail:"A rough, subjective marker — but useful to track over weeks."},
    {type:"harder", label:"Hold longer", detail:"Extending the hold time deepens the passive relaxation effect."},
  ],
  media:[
    {t:"article",label:"Puppy Pose — technique and variations", src:"Dani Winks Flexibility", url:"https://www.daniwinksflexibility.com/flexopedia/puppy-pose"},
  ]},

{ id:"childspose-side", name:"Child's pose side stretch", cats:["thoracic"], fatigue:"low", level:1,
  targets:"The side body and lats, reaching both hands to one side while in a child's pose position.",
  why:"Adds a lateral, side-body component that a standard forward child's pose doesn't reach — useful for the lats and obliques specifically, alongside the more central shoulder stretch.",
  when:["recovery"], dosage:"3 × 20-30 s each side.",
  progression:"Reach further to the side, or lower the chest closer to the floor while reaching.",
  regression:"A smaller reach, keeping the hips closer to centered over the heels.",
  mistakes:"Letting the hips lift off the heels to chase a bigger reach — the stretch should come from the side body, not from repositioning the hips.",
  cues:"From child's pose, walk both hands over to one side, feeling the stretch down the opposite side of your body. Keep your hips settled back toward your heels throughout.",
  pairs:"A natural extension of your regular child's pose work, adding lateral coverage the forward version misses.",
  source:"A recognized lateral variant of the standard child's pose family, commonly sequenced alongside the forward-reaching and hands-back versions in yoga-based mobility routines.",
  upgrades:[
    {type:"measurable", label:"Log how far you reach", detail:"Track your reach distance to the side as the side body opens up."},
    {type:"harder", label:"Lower the chest", detail:"Bringing the chest closer to the floor while reaching increases the stretch."},
  ],
  media:[
    {t:"article",label:"Puppy Pose — technique and variations", src:"Dani Winks Flexibility", url:"https://www.daniwinksflexibility.com/flexopedia/puppy-pose"},
  ]},

{ id:"standing-chest-opener", name:"Standing chest opener", cats:["pecs"], fatigue:"low", level:1,
  targets:"Chest and front shoulders, clasping the hands behind the back and lifting to open the chest.",
  ...
  source:"A standard, widely taught chest-opening stretch; the straight-arm clasp-and-lift technique is consistent and low-disagreement across mobility sources.",
  upgrades:[
    {type:"measurable", label:"Log how far you lift", detail:"Track how high you can lift your clasped hands while keeping your chest open and back flat."},
    {type:"harder", label:"Straighten the arms fully", detail:"A fuller arm extension increases the stretch through the front shoulders."},
  ],
  media:[
    {t:"article",label:"25 Best Upper Body Warm Up Exercises", src:"Pliability", url:"https://pliability.com/stories/upper-body-warm-up-exercises"},
  ]},

{ id:"supine-spinal-twist", name:"Supine spinal twist", cats:["thoracic","rehab"], fatigue:"low", level:1,
  targets:"Thoracic (mid-back) rotation, lying on the back and gently lowering both knees to one side while the shoulders stay grounded.",
  why:"Restores mid-back rotation in a position that specifically protects the lower back — the lying position keeps the lumbar spine stable while the movement happens through the thoracic spine instead, which is exactly why this is commonly recommended both for general mobility and for anyone managing a lower-back issue.",
  when:["recovery"], dosage:"3-5 slow breaths each side.",
  progression:"Let the knees lower further as thoracic rotation improves, always staying in a comfortable, pain-free range.",
  regression:"Keep the knees higher, closer to center, and place a cushion under them for support.",
  mistakes:"Forcing the knees all the way to the floor before the range is actually there — let gravity do the work gradually rather than pushing.",
  cues:"Lie on your back, knees bent, feet flat. Let both knees fall gently to one side while turning your head the opposite way. Keep both shoulders on the floor throughout — that's what keeps this safe for the lower back specifically.",
  pairs:"A gentle finisher for any evening release, and directly relevant if you're managing a lower-back issue alongside your regular mobility work.",
  source:"Cross-checked against the same guidance already reviewed for lower-back health — a supine (lying) twist is specifically favored over a seated twist because it protects the lumbar spine while still restoring thoracic rotation.",
  upgrades:[
    {type:"measurable", label:"Log how close the knees get to the floor", detail:"Track range over time — a gradual, patient marker."},
    {type:"harder", label:"Extend the top arm", detail:"Reaching the top arm further overhead adds a gentle chest-opening component to the twist."},
  ],
  media:[
...
{ id:"stallbar-side-kicks", name:"Stall bar side kicks", cats:["hips"], fatigue:"low", level:1,
  targets:"Hip abductors and glute medius, kicking one straight leg out to the side while holding a stall bar for support.",
  why:"A dynamic warm-up for the exact hip abduction the human flag depends on — the flag is held largely by lateral hip and core tension, and this primes that pattern before loading it.",
  when:["before"], dosage:"10 each side.",
  progression:"Kick higher, or slow the return for more control.",
  regression:"A lower kick height, and hold the bar more firmly for balance.",
  mistakes:"Leaning the torso away from the kicking leg to get more height — that's compensation, not range; letting the leg bend instead of staying straight and pointed.",
  cues:"Stand tall facing the stall bars, holding on lightly. Kick one straight, pointed leg directly out to the side, keeping your torso upright, then lower it under control.",
  pairs:"A natural warm-up pairing with side plank work before any flag session.",
  source:"Standard dynamic hip abduction warm-up; the straight-leg, upright-torso technique is consistent across mobility and gymnastics warm-up sources.",
  upgrades:[
    {type:"measurable", label:"Log kick height", detail:"Track how high you can kick while keeping the torso genuinely upright."},
    {type:"harder", label:"Slow the return", detail:"A controlled lowering phase adds real abductor demand."},
  ],
  media:[{t:"article",label:"Warm-ups and Cool-downs", src:"U.S. Army Holistic Health & Fitness", url:"https://h2f.army.mil/Portals/141/pdfs/physical/Warm%20Ups%20and%20Cool%20Downs.pdf"}]},

{ id:"vertical-flag-hold", name:"Vertical flag hold", cats:["rib","scap"], fatigue:"med", level:2,
  targets:"The push-pull tension of a flag, held with the body vertical alongside the bar and the legs hanging relaxed toward the floor.",
  why:"The entry point to the whole human flag line — it teaches the fundamental bottom-arm-push, top-arm-pull tension with almost no leverage demand, since the legs hang straight down rather than being held out.",
  when:["skill"], dosage:"2 each side.",
  progression:"Hold longer, or begin drawing the knees up toward a tuck once the vertical position feels secure.",
  regression:"Keep the feet lightly touching the floor for partial support.",
  mistakes:"Hanging passively from the top arm instead of actively pushing with the bottom arm — the push is what actually holds you up.",
  cues:"Grip the bar with your top hand high and bottom hand low, push hard through the bottom arm while pulling with the top, and let your legs hang relaxed toward the floor.",
  pairs:"Stage 1 of your Human Flag skill line — everything else in that tree builds on this exact tension.",
  source:"Standard human flag progression entry point; the push-pull tension principle is consistent across calisthenics coaching sources.",
  upgrades:[
    {type:"measurable", label:"Log hold time each side", detail:"Track duration and build it gradually."},
    {type:"harder", label:"Draw the knees up", detail:"Beginning to tuck the knees is the direct next step toward a chamber hold."},
  ],
  media:[{t:"article",label:"Human flag progression reference", src:"Balance Addicts", url:"https://balanceaddicts.com/blogs/handstands/handstand-drills-for-beginners"}]},

{ id:"chamber-to-extended-flag", name:"Chamber hold to extended flag", cats:["rib","compression"], fatigue:"high", level:3,
  targets:"Flag strength through two positions in one set — kicking into a tucked chamber hold, then extending the legs up toward the ceiling and holding.",
  why:"Genuinely two drills stacked into one: the chamber hold builds the base tension, then extending the legs toward the ceiling adds real lever length while staying easier than a horizontal straddle. A useful bridge between tuck and straddle work.",
  when:["skill"], dosage:"2 each side, 10 s in the extended position.",
  progression:"Hold the extended position longer, or begin lowering the legs toward horizontal rather than straight up.",
  regression:"Stay in the chamber hold without extending, or shorten the extended hold significantly.",
  mistakes:"Losing the bottom-arm push as the legs extend — the added lever makes it tempting to hang from the top arm instead; letting the hips rotate away from the bar.",
  cues:"Kick up into a tucked chamber hold first and stabilise there. Then extend both legs up toward the ceiling and hold, keeping the bottom arm pushing hard throughout.",
  pairs:"A natural progression between the chamber hold and straddle flag stages of your Human Flag line.",
  source:"A combined variant of standard human flag progressions; the legs-vertical position is a recognised intermediate between tuck and horizontal, since it keeps the centre of mass closer to the bar.",
  upgrades:[
    {type:"measurable", label:"Log the extended hold time", detail:"Track how long you hold the legs-up position before the tension breaks."},
    {type:"harder", label:"Lower the legs toward horizontal", detail:"Bringing the legs down from vertical adds real leverage demand."},
  ],
  media:[{t:"article",label:"Human flag progression reference", src:"Balance Addicts", url:"https://balanceaddicts.com/blogs/handstands/handstand-drills-for-beginners"}]},

{ id:"straddle-flag-spotted", name:"Straddle flag (spotted)", cats:["rib","compression"], fatigue:"high", level:3,
  targets:"A horizontal flag with the legs straddled wide, held with a spotter's assistance.",
  why:"The straddle reduces the lever compared to legs-together, and a spotter lets you spend real time in a position you can't yet hold alone — which is how the strength for it actually gets built.",
  when:["skill"], dosage:"3 each side.",
  progression:"Reduce how much the spotter assists, or narrow the straddle slightly.",
  regression:"More spotter support, or a wider straddle.",
  mistakes:"Letting the hips drop toward the floor rather than staying level with the shoulders; relying on the spotter to hold the whole position rather than working at your own limit.",
  cues:"Kick up with the spotter's support, straddle the legs wide, and fight to keep your hips level with your shoulders. Keep pushing hard through the bottom arm the whole time.",
  pairs:"Stage 4 of your Human Flag line — the direct step before a full flag.",
  source:"Standard human flag progression; the straddle-before-full sequencing and the value of spotted time-under-tension are consistent across calisthenics coaching sources.",
  upgrades:[
    {type:"measurable", label:"Log how much help you needed", detail:"Track whether the spotter is taking most, some, or almost none of your weight."},
    {type:"harder", label:"Reduce the assistance", detail:"Less spotter support is the real progression here, more than longer holds."},
  ],
  media:[{t:"article",label:"Human flag progression reference", src:"Balance Addicts", url:"https://balanceaddicts.com/blogs/handstands/handstand-drills-for-beginners"}]},

{ id:"side-lying-oblique-raise", name:"Side-lying oblique raise", cats:["rib"], fatigue:"med", level:2,
  targets:"Obliques through a full range, lying on your side on a box with the torso free to bend down and crunch up.",
  why:"Trains the exact lateral flexion strength the flag demands, through a much bigger range than a side plank allows — the box lets your torso travel well below horizontal and back up, which no floor-based drill can match.",
  when:["skill"], dosage:"3 × 8 each side.",
  progression:"Increase the range at both ends, or slow the tempo.",
  regression:"A smaller range, and more support from the spotter or your hands.",
  mistakes:"Rushing the movement instead of controlling both directions; twisting the torso forward rather than staying purely lateral.",
  cues:"Lie on your side on the box with your hips supported and torso free, a spotter holding your legs. Lower your torso as far down as comfortable, then crunch up as high as you can, keeping the movement purely sideways.",
  pairs:"A direct strength complement to your flag work — this builds the lateral core the flag is held with.",
  source:"A Roman-chair-style lateral flexion exercise; the supported-hips, free-torso setup is standard for training obliques through a fuller range than floor work allows.",
  upgrades:[
    {type:"measurable", label:"Log reps with full range", detail:"Track how many reps keep the full down-and-up range before it shortens."},
    {type:"harder", label:"Add a light weight at the chest", detail:"Holding a small plate increases the demand once bodyweight feels controlled."},
  ],
  media:[{t:"article",label:"Oblique Exercises", src:"Calisthenics Forge", url:"https://calisthenicsforge.com/oblique-exercises/"}]},

{ id:"stallbar-side-stretch", name:"Stall bar side stretch", cats:["thoracic"], fatigue:"low", level:1,
  targets:"The side body and lats, holding a stall bar and arching the outer arm overhead into a side bend.",
  why:"Opens the same lateral line the flag loads hard — a natural counter-stretch after flag work, and the fixed bar lets you lean into more range than a free-standing side bend.",
  when:["recovery"], dosage:"3 × 20-30 s each side.",
  progression:"Step further from the bar, or reach the outer arm further overhead.",
  regression:"Stand closer to the bar and reduce the lean.",
  mistakes:"Twisting the torso forward instead of staying in a pure side bend; pulling hard with the gripping arm rather than letting the lean create the stretch.",
  cues:"Hold the stall bar with one hand, step your feet away, and arch your outer arm up and over your head, leaning away from the bar. Keep your chest facing forward.",
  pairs:"A natural finisher after flag work, alongside the chest opener and hip hang.",
  source:"Standard lateral stretch adapted to a fixed anchor; consistent with how stall bars are used for assisted end-range stretching.",
  upgrades:[
    {type:"measurable", label:"Log your distance from the bar", detail:"Standing further away deepens the stretch — track it."},
    {type:"harder", label:"Reach further overhead", detail:"A fuller overhead arm reach increases the lat and side-body stretch."},
  ],
...
{ id:"stallbar-chest-opener", name:"Stall bar chest opener", cats:["pecs"], fatigue:"low", level:1,
  targets:"Chest and front shoulders, holding a stall bar behind you and stepping away to open the chest.",
  why:"A deeper version of a free-standing chest opener — the fixed bar lets you step forward and control the stretch depth precisely, rather than being limited by your own shoulder range.",
  when:["recovery"], dosage:"3 × 20-30 s.",
  progression:"Step further forward from the bar, or hold a lower rung.",
  regression:"Step closer to the bar, or hold a higher rung.",
  mistakes:"Rounding the upper back or letting the shoulders shrug up as you step away — stand tall and let the stretch come from the chest opening.",
  cues:"Face away from the stall bars, reach back and grip a bar behind you with both hands, then step forward gradually until you feel the chest open.",
  pairs:"A natural pairing with your existing doorway pec stretch — same target, more adjustable depth.",
  source:"Standard chest-opening stretch adapted to a fixed anchor; consistent with how stall bars are used for depth-adjustable stretching.",
  upgrades:[
    {type:"measurable", label:"Log your distance from the bar", detail:"Track how far forward you can step while staying comfortable."},
    {type:"harder", label:"Hold a lower rung", detail:"A lower grip point increases the shoulder extension demand."},
  ],
  media:[{t:"article",label:"Stall Bar Exercises for Mobility and Flexibility", src:"Vahva Fitness", url:"http://vahvafitness.com/stall-bar-exercises-mobility-flexibility/"}]},

{ id:"stallbar-hip-hang", name:"Stall bar hip hang", cats:["lats","hips"], fatigue:"low", level:1,
  targets:"Lats, shoulders and hips, gripping a high stall bar with the feet on a low rung and pushing the hips away.",
  why:"A genuinely decompressive stretch that opens the lats and hips at once — the fixed foot position lets you drive the hips back much further than a free hang allows.",
  when:["recovery"], dosage:"3 × 20-30 s.",
  progression:"Push the hips further away, or grip a higher rung.",
  regression:"Less hip push, or a lower hand position.",
  mistakes:"Letting the lower back arch hard rather than keeping a long, neutral spine as the hips travel back.",
  cues:"Step your feet onto a low rung, grip a high bar with both hands, and push your hips back and away from the bar, letting your arms and lats lengthen.",
  pairs:"A natural finisher after flag or pulling work, alongside the side stretch and chest opener.",
  source:"Standard stall bar hang variation; cross-checked against Vahva Fitness's stall bar mobility guidance on using the fixed foot position to increase hip and lat range.",
  upgrades:[
    {type:"measurable", label:"Log how far the hips travel", detail:"Track how far back you can push while keeping a long spine."},
...
const VIDEO = {
  ...
  "neck-rotations":         {yt:"", title:"", src:"", status:"missing", why:"No dedicated video confirmed — extremely standard movement."},
  "shoulder-rolls":         {yt:"", title:"", src:"", status:"missing", why:"No dedicated video confirmed — worth finding one, this is often lumped in with arm circles content."},
  "wide-forward-fold":      {yt:"", title:"", src:"", status:"missing", why:"No dedicated video confirmed — standard yoga pose, worth finding one."},
  "kneeling-chest-floor":   {yt:"", title:"", src:"", status:"missing", why:"No dedicated video confirmed for this specific active-finger variant."},
  "prone-iyt-raises":       {yt:"", title:"", src:"", status:"missing", why:"No single clean video confirmed across the sources checked, worth finding one given this is a real strengthening exercise, not just a stretch."},
  "band-facepull-press":    {yt:"", title:"", src:"", status:"missing", why:"No dedicated single-arm video confirmed — the two-handed version is documented but no clean video found."},
  ...
  "stallbar-pike-hollow":    {yt:"7XiRYlOpi0A", title:"Stall Bar Exercises for Compression and Press Handstand", src:"YouTube", status:"ok"},
  "hollow-activation":       {yt:"", title:"", src:"", status:"missing", why:"No dedicated video confirmed for this specific teaching progression — worth finding one."},
  ...
  "supine-spinal-twist":     {yt:"", title:"", src:"", status:"missing", why:"No dedicated video confirmed — worth finding one given this is also relevant to your lower-back work."},
...
{ id:"human-flag", name:"Human flag", short:"Human flag", fam:"Human flag", depth:"full",
  ...
  stages:[
   {n:1, name:"Vertical hold", target:"Vertical flag 3×15 s", pass:{type:"min",value:15}, match:["Vertical flag hold"],
    ...
    drills:["vertical-flag-hold","scapular-pushups","hollow-line"]},
   {n:2, name:"Chamber hold", target:"Tuck flag 3×10 s", pass:{type:"min",value:10}, match:["Chamber hold (tuck flag)","Spotted flag hold"],
    ...
    drills:["hollow-line","bodyline-drill","side-lying-oblique-raise"]},
   ...
   {n:4, name:"Straddle", target:"Straddle flag 5 s", pass:{type:"min",value:5}, match:["Straddle flag","Flag negative"],
    ...
    drills:["straddle-flag-spotted","chamber-to-extended-flag","pancake","middle-split","butterfly-stretch"]},
...
const WORKOUTS = [
 { id:"w-flag-class", name:"Calisthenics Class — Human Flag Focus", tax:"core", seeded:true,
   ...
   items:[
     {ref:"dislocates", sets:2, reps:"15"},
     {ref:"standing-side-bend", sets:2, reps:"10, PVC only"},
     {ref:"side-plank-hip-dips", sets:2, reps:"8 each side"},
     {ref:"stallbar-side-kicks", sets:2, reps:"10 each side"},
     {ref:"vertical-flag-hold", sets:1, reps:"2 each side"},
     {ref:"chamber-to-extended-flag", sets:1, reps:"2 each side, 10s extended"},
     {ref:"straddle-flag-spotted", sets:1, reps:"3 each side"},
     {ref:"side-lying-oblique-raise", sets:3, reps:"8 each side"},
     {ref:"stallbar-side-stretch", sets:1, reps:"each side"},
     {ref:"stallbar-chest-opener", sets:1, reps:"—"},
     {ref:"stallbar-hip-hang", sets:1, reps:"—"},
     {ref:"kneeling-chest-floor", sets:1, reps:"—"},
     {ref:"supine-spinal-twist", sets:1, reps:"each side"},
     {ref:"wide-forward-fold", sets:1, reps:"—"},
   ]},
 ...
 { id:"w-hs-newseason", name:"Handstand Lesson — Activation & Mobility Focus", tax:"handstand", seeded:true,
   ...
   items:[
     ...
     {ref:"wrist-prep", sets:1, reps:"—"},
     {ref:"reverse-wrist-pushups", sets:1, reps:"10"},
     {ref:"fingertip-plank", sets:1, reps:"hold"},
     {ref:"straddle-plank", sets:3, reps:"20s hold"},
     {ref:"stallbar-pike-hollow", sets:2, reps:"8"},
     {ref:"hollow-activation", sets:1, reps:"10"},
     {ref:"wall-angels", sets:1, reps:"8"},
     {ref:"stallbar-hollow-kicks", sets:2, reps:"10 each leg"},
     {ref:"weighted-shrugs", sets:1, reps:"10, 10kg"},
     {ref:"hollow-rocks", sets:1, reps:"10"},
     {ref:"kickup-practice", sets:3, reps:"5 in a row, no balance"},
     {ref:"wall-straddle-open", sets:1, reps:"4 attempts"},
     {ref:"freestanding-holds", sets:1, reps:"4 max holds, spotted"},
     {ref:"straddle-negatives", sets:1, reps:"with spotter"},
     {ref:"childspose-handsback", sets:1, reps:"—"},
     {ref:"kneeling-chest-floor", sets:1, reps:"—"},
     {ref:"childspose-side", sets:1, reps:"each side"},
     {ref:"cobra-pose", sets:1, reps:"—"},
     {ref:"standing-chest-opener", sets:1, reps:"—"},
     {ref:"supine-spinal-twist", sets:1, reps:"each side"},
   ]},
