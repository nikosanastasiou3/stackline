...
{ id:"back-lever", name:"Back lever", fam:"Back lever", depth:"structure",
  goal:"A horizontal full-body hold below the bar, face down, with straight arms.",
  prereq:"A comfortable German hang and a controlled skin the cat.",
  reality:"Usually faster to a tuck than front lever, since gravity assists the entry rotation — but straddle and full still take real time, same tendon-adaptation patience as any straight-arm hold.",
  stages:[
   {n:1, name:"German hang", target:"German hang held 20 s", pass:{type:"min",value:20}, match:["German hang"],
    crit:"20 s hanging inverted with straight arms and open shoulders, no pain.",
    why:"Builds the shoulder-extension range every later stage depends on.",
    drills:["skin-the-cat"]},
   {n:2, name:"Tuck", target:"Tuck back lever 3×10 s", pass:{type:"min",value:10}, match:["Tuck back lever"],
    crit:"10 s tucked, back parallel to the floor, shoulders protracted not shrugged.",
    why:"The same rotation as skin the cat, held instead of passed through.",
   ...
   {n:3, name:"One leg", target:"One-leg back lever 5 s each side", pass:{type:"min",value:5}, match:["One-leg back lever"],
    crit:"5 s per side without the hips sagging.",
    why:"Halfway leverage before straddle, and it exposes side-to-side gaps.",
    drills:["tuck-back-lever"]},
   {n:4, name:"Straddle", target:"Straddle back lever 5 s", pass:{type:"min",value:5}, match:["Straddle back lever"],
    crit:"5 s straddled and horizontal, arms locked straight.",
    why:"The loaded, advanced version of skin the cat — this is where the real strength gets built.",
   ...
   {n:5, name:"Full", target:"Full back lever 5 s", pass:{type:"min",value:5}, match:["Full back lever"],
    crit:"5 s fully extended, legs together, horizontal.",
    why:"From here it becomes rows and dynamic transitions.",
    drills:[]}],
  support:{strength:["Pull-up","Body row","Hollow body hold","Scapular pull-up"],
           mobility:["Overhead lat stretch","Doorway pec stretch","Puppy pose (classic)"]},
  volume:"2–3 sessions a week, short holds with full rest — same straight-arm caution as front lever.",
  plateau:"If a stage stalls, add German hang holds and straight-arm pull-downs rather than more lever attempts."},

{ id:"pistol-squat-skill", name:"Pistol squat", fam:"Legs & glutes", depth:"structure",
  goal:"A full single-leg squat from standing to full depth and back, unassisted, on either leg.",
  prereq:"A clean bodyweight squat and basic single-leg balance.",
  reality:"GMB's coaching is explicit that shrimp squat is usually the friendlier entry point before pistol — weight stays over the midfoot rather than shifting to the heel. Most people get there in weeks to a few months with consistent work; ankle mobility is the most common limiter, not raw leg strength.",
  stages:[
...
{ id:"lsit", name:"L-sit", fam:"Core", depth:"structure",
  goal:"Legs held straight out in front at hip height, supported on straight arms, for a real hold.",
  prereq:"A solid hollow body hold and basic straight-arm support strength.",
  reality:"Compression and hip-flexor endurance are usually the limiter, not raw ab strength — most people can hold a tuck quickly but the jump to full legs extended takes months of consistent compression work.",
  stages:[
...
{ id:"oapu", name:"One-arm pull-up", fam:"Pull-bar", depth:"structure",
  goal:"A full pull-up on a single arm, from a dead hang to chin over the bar, unassisted.",
  prereq:"Strong strict pull-ups — this is a strength ceiling, not a technique trick.",
  reality:"A genuinely elite bodyweight strength goal. Most sources treat the archer pull-up and controlled one-arm negative as the real milestones — the full rep itself often takes years of dedicated pulling strength work.",
  stages:[
...
{ id:"dragon-flag", name:"Dragon flag", fam:"Core", depth:"structure",
  goal:"A straight body held rigid from the shoulders down, supported only at the shoulders, lowering and raising under control.",
  prereq:"A strong hollow body hold and comfortable straight-leg control.",
  reality:"Popularized by Bruce Lee and still one of the most demanding core holds in calisthenics — full straight-leg control usually takes months of tuck and straddle work first.",
  stages:[
...
{ id:"hspu", name:"Handstand push-up", fam:"Press handstand", depth:"structure",
  goal:"A full pressing movement from a handstand, bending and extending the arms, distinct from the balance-focused press handstand.",
  prereq:"A comfortable wall handstand hold and solid pike push-up strength.",
  reality:"Genuinely a different skill from your press handstand work — press is about the balance transition into a handstand, HSPU is about pressing strength once you're already there. Coaches commonly track these separately for exactly that reason.",
  stages:[
