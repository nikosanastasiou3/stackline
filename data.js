...
{ id:"bench-lat-opener", name:"Extended puppy pose (elbows elevated)", cats:["lats","thoracic","overhead"], fatigue:"low", level:2,
  targets:"Lats, thoracic extension, and deep overhead flexion with the arms locked in a fixed line.",
  ...
  progression:"As depth increases, lower the block height, or move into the active press variation (puppy pose active press) to add end-range strength.",
  ...
  source:"This is extended puppy pose (uttana shishosana) from yoga, adapted with elevated elbows — a version widely used in handstand-flexibility content (Antranik Kizirian's wall variation, Dani Winks Flexibility's active press).",
  upgrades:[
  ...
  media:[
    ...
    {t:"article",label:"Puppy Dog Pose Against Wall (overhead flexion + t-spine)", src:"Antranik Kizirian", url:"https://antranik.org/puppy-dog-pose-against-wall/"},
    {t:"article",label:"Puppy Pose Active Press (loaded variation)", src:"Dani Winks Flexibility", url:"https://www.daniwinksflexibility.com/flexopedia/puppy-pose-active-press"},
  ]},
...
{ id:"lat-pails-rails", name:"Lat stretch PAILs/RAILs", cats:["lats","flexion"], fatigue:"med", level:4,
  ...
  when:["before","recovery"],
  dosage:"20–30 s passive lat stretch → 10 s PAIL → 10 s RAIL → repeat 2–3 rounds per side.",
  ...
  pairs:"Pair with pails-rails-flexion in the same session for a complete active-flexibility block — but not more than 2–3x a week; this is demanding tissue work.",
  source:"Functional Range Conditioning method, applied to the lat/shoulder-extension line specifically for overhead athletes.",
  upgrades:[
...
const VIDEO = {
  ...
  "bench-lat-opener":     {yt:"szi5tN8NpKY", title:"How To Do Puppy Pose", src:"YouTube", status:"ok"},
...
"Handstand":[["Wall plank",1],["Chest-to-wall handstand",2],["Back-to-wall handstand",2],["Handstand kick-up",2],["Toe pulls",3],["Heel pulls",3],["Freestanding handstand",3],["Handstand shrug",3],["Handstand walk",4],["Tuck handstand",3],["Straddle handstand",4],["One-arm handstand prep",5],["Handstand pirouette",4]],
...
{ id:"handstand", name:"Freestanding handstand", fam:"Handstand", depth:"full",
  ...
  stages:[
   ...
   {n:4, name:"Freestanding holds", target:"Consistent 10 s freestanding, kick-up 8/10",
    match:["Freestanding handstand","Handstand kick-up","Tuck handstand"],
   ...
   {n:5, name:"Own it", target:"30 s freestanding, straight line, calm",
    match:["Freestanding handstand","Handstand walk","Handstand pirouette","Straddle handstand"],
