...
const MUSCLES = {
  ...
  "band-pullapart":     {work:{p:["delts_rear","traps"],s:["forearms"]}},
  ...
  "band-facepull":      {work:{p:["delts_rear","traps"],s:["forearms"]}},
  "ring-scap-work":     {work:{p:["traps_lower","lats"],s:["forearms"]}},
  "neck-rotations":         {work:{p:["traps_upper"],s:[]}},
  "shoulder-rolls":         {work:{p:["traps_upper","delts"],s:[]}},
  "wide-forward-fold":      {stretch:{p:["hamstrings","adductors"],s:["erectors"]}},
  "kneeling-chest-floor":   {stretch:{p:["lats","delts_front"],s:["forearms"]}},
  "prone-iyt-raises":       {work:{p:["delts_rear","traps","traps_lower"],s:["forearms"]}},
  "band-facepull-press":    {work:{p:["delts_rear","traps","delts"],s:["forearms"]}},
  "wall-pike-push":         {stretch:{p:["hamstrings"],s:["delts"]}, work:{p:["abs"],s:["hipflexors"]}},
  ...
  "dead-bug":                {work:{p:["abs"],s:["hipflexors"]}},
  "bird-dog":                {work:{p:["erectors"],s:["glutes","abs"]}},
  "cobra-pose":              {stretch:{p:["abs"],s:["hipflexors"]}, work:{p:["erectors"],s:[]}},
  "side-lying-hip-abduction": {work:{p:["glutes"],s:[]}},
  "fingertip-plank":         {work:{p:["forearms"],s:["delts_front","abs"]}},
  "straddle-plank":          {work:{p:["abs","delts"],s:["adductors"]}},
  "stallbar-pike-hollow":    {stretch:{p:["hamstrings"],s:["delts"]}, work:{p:["abs"],s:["delts_front"]}},
  "hollow-activation":       {work:{p:["abs"],s:[]}},
  "stallbar-hollow-kicks":   {work:{p:["abs"],s:["delts","hipflexors"]}},
  "weighted-shrugs":         {work:{p:["traps_upper"],s:["forearms"]}},
  "hollow-rocks":            {work:{p:["abs"],s:["hipflexors"]}},
  "wall-straddle-open":      {work:{p:["delts","abs"],s:["adductors"]}},
  "childspose-handsback":    {stretch:{p:["delts_front"],s:["lats"]}},
  ...
  "prone-band-row":          {work:{p:["lats","traps"],s:["forearms","biceps"]}},
  ...
  "stallbar-side-kicks":     {work:{p:["glutes"],s:["adductors"]}},
  "vertical-flag-hold":      {work:{p:["lats","delts"],s:["obliques","forearms"]}},
  "chamber-to-extended-flag":{work:{p:["obliques","lats"],s:["delts","abs"]}},
  "straddle-flag-spotted":   {work:{p:["obliques","lats","delts"],s:["abs","adductors"]}},
  "side-lying-oblique-raise":{work:{p:["obliques"],s:["erectors"]}},
  "stallbar-side-stretch":   {stretch:{p:["lats","obliques"],s:[]}},
  "stallbar-chest-opener":   {stretch:{p:["pecs","delts_front"],s:[]}},
  "stallbar-hip-hang":       {stretch:{p:["lats","hipflexors"],s:["delts_front"]}},
  "small-arm-circles":       {work:{p:["delts"],s:["traps_upper"]}},
  "single-arm-shrug":        {work:{p:["traps_upper"],s:[]}},
  "wall-straddle-stack":     {work:{p:["delts","abs"],s:["traps_upper","forearms"]}},
  "wall-straddle-snap":      {work:{p:["adductors","abs"],s:["delts"]}},
  "straddle-balance-snap":   {work:{p:["delts","abs","adductors"],s:["forearms"]}},
...
"neck-rotations":{desc:"Standing tall, you circle your head slowly through a full comfortable range to warm the neck before training.",
 steps:["Stand or sit tall with relaxed shoulders.",
  "Slowly drop your chin toward your chest.",
  "Roll your head to one side, then back, then to the other side, completing a full circle.",
  "Keep the movement slow and controlled — don't force the range.",
  "Complete 10 rotations, then reverse direction.",
  "Stop anywhere you feel sharp discomfort rather than pushing through it."],
 check:"If you're moving quickly through the circle, slow down — the point is warming the joint through its full range, not speed."},

"shoulder-rolls":{desc:"Standing with your arms relaxed by your sides, you roll your shoulders up, back, and down in a circular pattern to warm the shoulder girdle.",
 steps:["Stand tall with your arms hanging relaxed by your sides.",
  "Lift both shoulders up toward your ears.",
  "Roll them back, squeezing the shoulder blades together.",
  "Let them drop down and then roll forward slightly to complete the circle.",
  "Complete 10 rolls, then reverse direction.",
  "Keep the arms relaxed throughout — the movement comes entirely from the shoulders."],
 check:"If your shoulders barely seem to move, you're likely doing a small shrug rather than a full roll — exaggerate the up-back-down-forward pattern."},

"wide-forward-fold":{desc:"Standing with your feet wide apart, you fold forward from the hips, reaching your hands toward the floor between your legs.",
 steps:["Stand with your feet wider than shoulder-width apart, toes pointing slightly in.",
  "Place your hands on your hips.",
  "Inhale and lengthen your spine upward.",
  "Exhale and hinge forward from your hips, keeping a flat back as long as possible.",
  "Bring your hands or fingertips to the floor, or rest them on blocks if the floor isn't reachable.",
  "Hold, breathing steadily, then press through your feet to rise back up with a flat back."],
 check:"If your back is rounding heavily to reach the floor, you've gone past your current range — bend the knees slightly or use blocks under your hands instead of forcing it."},

"kneeling-chest-floor":{desc:"Kneeling with your hips back toward your heels, you reach your arms forward and press your chest toward the floor, actively pressing your fingertips into the ground.",
 steps:["Kneel down and sit back toward your heels.",
  "Reach your arms forward along the floor.",
  "Let your chest and forehead sink down toward the floor.",
  "Actively spread your fingers and press your fingertips into the ground, rather than just resting your hands there.",
  "Hold, breathing steadily.",
  "Walk the hands back in to release."],
 check:"If your hips have lifted off your heels, you've drifted into a different stretch — sit back down toward your heels before continuing."},

"prone-iyt-raises":{desc:"Lying face down with straight arms and thumbs pointing up, you lift your arms a few inches through three angles — overhead, diagonal, and out to the sides — training the muscles that control your shoulder blades.",
 steps:["Lie face down, resting your forehead on a folded towel if needed for comfort.",
  "For the I: reach your arms straight overhead, close to your ears, thumbs up.",
  "Lift your arms a few inches off the floor, squeeze your shoulder blades down and together, hold briefly, then lower. Complete 10 reps.",
  "For the Y: reach your arms into a diagonal overhead position, roughly 45 degrees from your body, thumbs up.",
  "Lift, hold briefly, lower. Complete 10 reps.",
  "For the T: extend your arms straight out to your sides at shoulder height, thumbs up. Lift, hold briefly, lower. Complete 10 reps."],
 check:"If you feel this in your lower back rather than around your shoulder blades, you're using momentum or arching to throw the arms up — slow down and lift a smaller range, focusing the effort on the shoulder blades instead."},

"band-facepull-press":{desc:"Holding a band anchored in front of you with one hand, you pull it back into a face pull, then rotate and drive it overhead into a press, training the transition your shoulder makes going into an overhead position.",
 steps:["Anchor a light resistance band at roughly chest height.",
  "Hold one end with a single hand, arm extended toward the anchor point.",
  "Pull the band back toward your face, leading with your elbow high.",
  "At the top of the pull, rotate your hand and drive it straight overhead into a full press.",
  "Reverse the movement under control — lower from the press back into the pulled position, then extend back out.",
  "Complete the set, then switch arms."],
 check:"If the transition from pull to press feels rushed or disconnected, slow the whole sequence down — the value here is in the smooth rotation between the two positions, not speed."},

"wall-pike-push":{desc:"With your feet braced against a wall, you push from a folded position through a pike shape, straightening your knees while reaching your shoulders up toward your ears.",
 steps:["Get into a folded, compressed position with your feet against the base of a wall.",
  "Place your hands on the floor in front of you, arms straight.",
  "Actively push your feet into the wall as you begin to straighten your knees.",
  "As your legs straighten, reach your shoulders up toward your ears, same position as your press handstand shoulder work.",
  "Hold the extended pike position briefly, feeling the compression.",
  "Return to the folded start and repeat for the set."],
 check:"If your shoulders are rounding forward instead of reaching up toward your ears, the compression isn't translating into the position that actually carries over to your press work — reset the shoulder position before continuing."},

"weighted-pullover-stretch":{desc:"Lying on your back with light dumbbells, you let your straight arms reach back overhead under gravity, stretching your shoulders into a deeper flexion range than a bodyweight stretch alone.",
 steps:["Lie on your back, knees bent, feet flat on the floor.",
  "Hold a light dumbbell in each hand, arms extended straight up above your chest.",
  "Slowly let your arms reach back overhead, keeping them straight, letting the weight and gravity pull you into the stretch.",
  "Keep your lower back pressed flat against the floor throughout — don't let it arch to compensate.",
  "Hold at your end range for the target time.",
  "Bring the arms back up and lower the weights down carefully."],
 check:"If your lower back is lifting off the floor as your arms reach back, the weight is too heavy or you're forcing more range than you actually have — lighten the load and keep the back flat."},

"loaded-hollow-extension":{desc:"Starting tucked on an elevated box or bench, you extend both arms and legs at once into a full hollow shape while holding light dumbbells, building loaded strength through a position you already train.",
 steps:["Lie on your back on a box or bench, knees and arms tucked in tight, holding a light dumbbell in each hand.",
  "Brace your core and press your lower back into the surface.",
  "Extend both your arms and legs away from your body at the same time, reaching into a full hollow shape.",
  "Hold the extended position briefly, keeping your lower back pressed down throughout.",
  "Return to the tucked start under control.",
  "Repeat for the set."],
 check:"If your lower back lifts off the surface as you extend, you've gone past what your core can currently control at this load — use lighter weight or a shorter extension until the back stays flat throughout."},

"handstand-kick-switch":{desc:"Held in a chest-to-wall handstand, you alternate which foot rests on the wall, passing through a full legs-together handstand shape between each switch — staying inverted the whole set.",
 steps:["Get into a chest-to-wall handstand, facing the wall, with your body in a straight line.",
  "Rest one foot lightly on the wall and take the other leg off it.",
  "Bring the free leg across to meet the other, passing through a full legs-together handstand shape.",
  "Hold that legs-together position briefly — this is the part doing the real work.",
  "Continue the switch, placing the other foot on the wall and taking the first one off.",
  "Keep alternating for the set, staying inverted throughout rather than coming down between reps."],
 check:"If your hips are sagging or your back is arching as you tire, stop the set there — the quality of the line matters more than getting all the switches in, and a fatigued, bent handstand isn't training the shape you want."},
...
"dead-bug":{desc:"Lying on your back with your lower back pressed flat, you extend one arm overhead and the opposite leg away at the same time, training the core to keep the spine still while the limbs move.",
 steps:["Lie on your back, arms reaching straight up toward the ceiling, knees bent to 90 degrees over your hips (tabletop position).",
  "Exhale and press your lower back firmly into the floor. There should be no gap between your back and the floor.",
  "Keeping that press throughout, slowly extend your right arm overhead and your left leg out, hovering it just above the floor.",
  "Only go as far as you can while keeping your lower back completely flat — stop before it starts to arch.",
  "Return slowly to the start, then repeat on the other side.",
  "This is a general core-stability exercise, not a substitute for your physio's specific guidance — if anything feels sharp, or if symptoms travel down a leg, stop and check with them before continuing."],
 check:"If your lower back is lifting off the floor as your arm and leg extend, that's the range going too far right now — pull back to a smaller range where the back genuinely stays flat, even if that means barely moving the limbs at first."},

"bird-dog":{desc:"On hands and knees, you extend one arm forward and the opposite leg back at the same time, keeping your hips level and your spine still throughout.",
 steps:["Start on all fours, hands directly under your shoulders, knees directly under your hips.",
  "Brace your core gently, keeping your spine in a neutral position — no sagging, no arching.",
  "Slowly extend your right arm forward and your left leg back at the same time, both reaching to about parallel with the floor, no higher.",
  "Hold briefly, keeping your hips level — imagine a water bottle on your lower back that shouldn't fall.",
  "Return with control to the starting position, then repeat on the other side.",
  "This is general guidance, not a substitute for your physio's specific assessment — stop immediately if you feel anything sharp or radiating."],
 check:"If your hips are rotating toward the side of the raised leg, that's the most common fault — slow down and keep both hip bones pointing straight at the floor throughout, even if that means a smaller range."},

"cobra-pose":{desc:"Lying face down, you gently lift your chest using your hands as light support, creating a gentle extension through the spine.",
 steps:["Lie face down, palms flat on the floor beside your chest, elbows tucked in close to your body.",
  "Gently press through your palms to lift your chest, keeping your hip bones in light contact with the floor.",
  "Keep your shoulders relaxed, away from your ears, and let your lower back soften rather than actively arching.",
  "Come up only as far as feels completely comfortable — this should never feel like a forceful stretch.",
  "Hold briefly, then lower back down slowly.",
  "If anything travels down a leg during this movement, stop immediately and reduce the range significantly, or skip it that session."],
 check:"If you're pushing hard through your arms to force more height, ease off — the arms are a light prop here, not a lever, and forcing extra range is exactly the kind of thing worth avoiding while you're still monitoring how your back responds."},

"side-lying-hip-abduction":{desc:"Lying on your side, you lift your top leg straight up toward the ceiling, training the outer hip muscle that helps stabilize your pelvis with every step.",
 steps:["Lie on your side, body in a straight line, hips and feet stacked on top of each other.",
  "Brace your core gently for stability.",
  "Keeping your leg straight, lift your top leg up toward the ceiling, toes pointed very slightly toward the floor rather than the ceiling.",
  "Lift to about 30-45 degrees — you don't need to go higher than that.",
  "Lower slowly back down under control, without letting the leg rest fully between reps if you want continuous tension.",
  "Repeat for the set, then switch sides."],
 check:"If your torso is rotating backward as the leg lifts higher, that's compensation, not real hip strength — keep your body in a straight line and accept a smaller, controlled range instead."},

"fingertip-plank":{desc:"Holding a plank supported on your fingertips rather than your full palm, building genuine finger strength.",
 steps:["Set up in a standard high-plank position, hands under your shoulders.",
  "Lift your palms slightly, shifting your weight onto your fingertips.",
  "Spread your fingers and press each one down actively into the floor.",
  "Keep your body in a straight line from shoulders to heels, same as a normal plank.",
  "Hold, breathing normally, stopping the moment your fingers start to collapse flat.",
  "Lower your palms back down to release."],
 check:"If your fingers are flattening out under the load instead of staying curled and rigid, that's your signal to stop — grinding through with collapsed fingers doesn't build the strength this drill is for."},

"straddle-plank":{desc:"Holding a front-support plank with your legs opened wide into a straddle, combining shoulder and core stability with straddle-width hip positioning.",
 steps:["Set up in a standard high-plank position, hands under your shoulders.",
  "Walk your feet out wide into a straddle position, as wide as feels controlled.",
  "Keep your hips level and your shoulders stacked directly over your hands.",
  "Brace your core the same way you would in a regular plank.",
  "Hold for the target time, breathing normally.",
  "Walk your feet back together to release."],
 check:"If your hips are sagging as you widen the straddle, the core has stopped doing its job — bring the feet slightly closer together until the hips stay level again."},

"stallbar-pike-hollow":{desc:"With your hands fixed on a stall bar or wall-mounted support, you move between an actively pushed pike stretch and a compressed hollow position.",
 steps:["Stand facing a stall bar (or a wall used the same way), and place your hands on a rung or fixed point at roughly hip height.",
  "Hinge forward from the hips, pushing your chest down into a pike stretch, keeping your back neutral rather than rounded.",
  "Hold briefly, feeling the stretch through your hamstrings and shoulders.",
  "Reverse the movement, pushing up and forward into a hollow position, feeling compression through your whole line.",
  "Hold briefly at the hollow end too.",
  "Repeat for the set, moving smoothly between the two positions."],
 check:"If your back is rounding during the pike-stretch phase, that's spinal flexion, not the intended hip-hinge stretch — reset with a flatter back, even if that means less range."},

"hollow-activation":{desc:"Lying on your back in a neutral position, you use your abs to actively close the gap under your lower back, transitioning into an active hollow shape.",
 steps:["Lie on your back, arms and legs relaxed, in a comfortable neutral position.",
  "Notice the natural gap between your lower back and the floor.",
  "Exhale, and use your abs to press your lower back flat against the floor, closing that gap.",
  "Hold the closed position briefly.",
  "Release back to the neutral, relaxed position.",
  "Repeat for the set, focusing on the abs doing the work each time."],
 check:"If you're using your hip flexors to yank your pelvis into position instead of your abs pressing the back flat, slow down and focus specifically on the exhale-and-press pattern instead."},

"stallbar-hollow-kicks":{desc:"Holding an active hollow position on a stall bar, you kick one leg at a time without letting the hollow shape break.",
 steps:["Set up on a stall bar with your hands supporting your position, establishing a solid hollow body shape first.",
  "Once the hollow position feels locked in, kick one leg out and back under control.",
  "Keep everything else in your body still — the hollow shape shouldn't change as the leg moves.",
  "Return the leg and repeat on the same side for the set, then switch legs.",
  "If the hollow position breaks down at any point, reset it fully before continuing.",
  "Complete the target reps on each leg."],
 check:"If your hollow shape is visibly breaking every time the leg kicks, that means the kick is currently too big a disruption — slow the kick down and reduce its range until the hollow position holds through it."},

"weighted-shrugs":{desc:"Holding a weight plate or dumbbells at your sides, you shrug your shoulders straight up toward your ears, then lower under control.",
 steps:["Stand tall, holding a weight plate or a dumbbell in each hand at your sides, arms straight.",
  "Keeping your arms straight, shrug your shoulders straight up toward your ears.",
  "Squeeze briefly at the top.",
  "Lower back down under control, feeling a full stretch at the bottom.",
  "Repeat for the set.",
  "Avoid rolling the shoulders — this is a straight up-and-down movement."],
 check:"If you're rolling your shoulders forward or backward as part of the movement, that's added momentum, not more effective shrugging — keep it a strictly vertical motion."},

"hollow-rocks":{desc:"Holding a hollow body shape, you rock gently forward and backward, testing whether the position holds under continuous small movement.",
 steps:["Lie on your back, arms extended overhead, legs straight.",
  "Press your lower back flat into the floor and lift your shoulders and legs slightly off the ground, forming a shallow curved hollow shape.",
  "Gently shift your weight toward your shoulders, rocking slightly in that direction.",
  "Reverse the shift, rocking gently toward your legs.",
  "Keep the rocking small and controlled — the goal is a smooth motion with no sudden flat spot or \\u201cclunk.\\u201d",
  "Continue for the set, keeping the hollow tension consistent throughout."],
 check:"If you feel a distinct clunk or flat spot partway through the rock, that's a weak point in your hollow position — reduce the rocking range until the motion feels genuinely smooth all the way through."},

"wall-straddle-open":{desc:"From a wall-facing handstand, you gradually open your legs into a straddle, then push away from the wall to balance freestanding.",
 steps:["Kick up into a wall-facing handstand, finding a stable position first.",
  "Once balanced, gradually open your legs into a straddle, feeling how your balance point shifts as you do.",
  "Continue opening until you feel confident with the new balance point.",
  "Push gently away from the wall, committing to freestanding balance.",
  "Hold as long as you can, then come down under control.",
  "Reset and repeat for the target attempts."],
 check:"If you're opening the straddle too fast or the balance feels chaotic rather than a smooth shift, slow the opening down — the whole point is a controlled, gradual balance transition, not a rushed one."},

"childspose-handsback":{desc:"In a child's pose position, you let your arms rest passively alongside your body, reaching gently back toward your feet rather than forward.",
 steps:["Kneel down and sit back toward your heels.",
  "Fold forward, resting your chest and forehead toward the floor.",
  "Let your arms rest passively alongside your body, palms facing up, reaching gently back toward your feet.",
  "Let your shoulders fully relax — this variation depends on passive relaxation, not active reaching.",
  "Hold, breathing steadily.",
  "Sit back up slowly to release."],
 check:"If your shoulders feel tense or held rather than relaxed, consciously let them soften — this variant only works if the arms are genuinely passive, not actively engaged."},

"childspose-side":{desc:"From a child's pose position, you walk both hands over to one side, adding a lateral stretch through the side body.",
 steps:["Kneel down and sit back toward your heels.",
  "Fold forward into a child's pose position.",
  "Walk both hands over to one side, keeping your hips settled back toward your heels.",
  "Feel the stretch down the side of your body opposite to where your hands moved.",
  "Hold, breathing steadily, then walk the hands back to center.",
  "Repeat on the other side."],
 check:"If your hips are lifting off your heels as you reach to the side, you've shifted the stretch away from the side body — settle the hips back down before continuing."},

"standing-chest-opener":{desc:"Standing tall, you clasp your hands behind your back and lift them gently, opening the chest and front shoulders.",
 steps:["Stand tall with good posture.",
  "Clasp your hands together behind your back.",
  "Straighten your arms as much as comfortable.",
  "Gently lift your clasped hands away from your body, opening your chest.",
  "Keep standing tall throughout — don't round your upper back to compensate for limited shoulder range.",
  "Hold, breathing steadily, then release."],
 check:"If your upper back is rounding forward as you lift your hands, that's compensation rather than genuine shoulder opening — stand taller and lift less if needed."},

"supine-spinal-twist":{desc:"Lying on your back, you let both knees fall gently to one side while your shoulders stay grounded, rotating through your mid-back specifically.",
 steps:["Lie on your back, knees bent, feet flat on the floor.",
  "Rest both arms out to the sides at shoulder height, palms facing down.",
  "Keeping your knees together, slowly let them lower to one side.",
  "At the same time, gently turn your head the opposite direction.",
...
"stallbar-side-kicks":{desc:"Standing tall and holding a stall bar for balance, you kick one straight leg out to the side and lower it under control.",
 steps:["Stand facing the stall bars, holding on lightly with both hands for balance.",
  "Stand tall with your torso upright and core lightly braced.",
  "Kick one straight, pointed leg directly out to the side.",
  "Keep your torso upright — don't lean away from the kicking leg to get more height.",
  "Lower the leg back down under control.",
  "Complete the set, then switch sides."],
 check:"If your torso is leaning away from the kicking leg to gain height, that's compensation rather than real hip range — stand taller and accept a lower kick."},

"vertical-flag-hold":{desc:"Gripping a vertical bar with hands apart, you push with the bottom arm and pull with the top to hold your body alongside the bar, legs hanging relaxed toward the floor.",
 steps:["Stand beside a vertical bar or stall bar upright.",
  "Grip it with your top hand high above your head and your bottom hand roughly at chest height.",
  "Push hard through your bottom arm while pulling with your top arm.",
  "Lift your feet off the floor, letting your legs hang relaxed straight down.",
  "Hold the position, keeping the push-pull tension active throughout.",
  "Lower down under control, then switch sides."],
 check:"If you feel like you're hanging from your top arm rather than pushing with your bottom arm, the tension is wrong — the bottom arm push is what actually holds a flag up."},

"chamber-to-extended-flag":{desc:"You kick up into a tucked flag position, stabilise there, then extend both legs up toward the ceiling and hold.",
 steps:["Set up beside the bar with your top hand high and bottom hand low, same grip as any flag.",
  "Kick up into a tucked chamber position, knees drawn toward your chest, hips level with your shoulders.",
  "Stabilise there for a moment, keeping the bottom arm pushing hard.",
  "Extend both legs up toward the ceiling, keeping them together.",
  "Hold the extended position for the target time.",
  "Return to the tuck and come down under control, then switch sides."],
 check:"If the bottom-arm push fades as your legs extend, that's the added leverage winning — shorten the extended hold and rebuild the tuck strength first."},

"straddle-flag-spotted":{desc:"With a spotter assisting, you hold a horizontal flag with your legs straddled wide.",
 steps:["Set up beside the bar with your usual flag grip, top hand high and bottom hand low.",
  "Have your spotter ready to support at your hips or legs.",
  "Kick or press up into the flag position with the spotter's help.",
  "Straddle your legs wide once you're up — the wider straddle reduces the leverage.",
  "Fight to keep your hips level with your shoulders, pushing hard through the bottom arm.",
  "Come down under control, then switch sides."],
 check:"If your hips are dropping below your shoulders, ask the spotter for slightly more support rather than fighting a collapsing position — quality time in a good position beats longer time in a bad one."},

"side-lying-oblique-raise":{desc:"Lying on your side on a box with your legs held and your torso free, you lower your upper body down and crunch it back up, training the obliques through a full range.",
 steps:["Lie on your side on a box or bench with your hips supported at the edge and your torso hanging free.",
  "Have a spotter hold your legs securely, or hook your feet under a support.",
  "Cross your arms over your chest or place your hands lightly at your temples.",
  "Lower your torso down toward the floor as far as comfortable.",
  "Crunch your torso back up sideways as high as you can, squeezing the obliques.",
  "Complete the set, then switch sides."],
 check:"If you're twisting forward as you crunch up, the movement has drifted away from pure lateral flexion — keep your chest facing straight ahead the whole time."},

"stallbar-side-stretch":{desc:"Holding a stall bar with one hand and stepping away, you arch your outer arm overhead into a deep side bend.",
 steps:["Stand side-on to the stall bars and grip a bar at roughly shoulder height with your nearest hand.",
  "Step your feet away from the bar so your arm straightens.",
  "Reach your outer arm up and over your head, arching toward the bar.",
  "Keep your chest facing forward rather than twisting toward the floor.",
  "Hold, breathing steadily, letting the lean create the stretch.",
  "Release and switch sides."],
 check:"If your torso is twisting to face the floor, you've lost the pure side bend — reset with your chest square to the front."},

"stallbar-chest-opener":{desc:"Facing away from the stall bars and gripping a bar behind you, you step forward gradually to open the chest and front shoulders.",
 steps:["Stand facing away from the stall bars.",
  "Reach back and grip a bar behind you with both hands, roughly at hip or waist height.",
  "Stand tall with your chest lifted.",
  "Step forward gradually, letting your arms extend behind you and your chest open.",
  "Stop at a comfortable stretch — don't force it by stepping too far.",
  "Hold, breathing steadily, then step back to release."],
 check:"If your upper back is rounding or your shoulders are shrugging up, step back toward the bar — stand tall and let the chest do the opening."},

"stallbar-hip-hang":{desc:"With your feet on a low rung and hands gripping a high bar, you push your hips back and away, lengthening through the lats and hips.",
 steps:["Step your feet onto a low stall bar rung.",
  "Reach up and grip a high bar with both hands.",
  "Straighten your arms and push your hips back and away from the bar.",
  "Keep your spine long and neutral rather than letting the lower back arch hard.",
  "Feel the stretch through your lats, shoulders and hips.",
  "Hold, breathing steadily, then step down to release."],
 check:"If your lower back is arching sharply rather than staying long, reduce how far you push the hips back — the stretch should feel like lengthening, not compressing."},

"small-arm-circles":{desc:"Arms held straight out to the sides at shoulder height, you make small, fast circles in each direction, building shoulder endurance through the isometric hold.",
 steps:["Stand tall with your arms straight out to the sides at shoulder height, forming a cross.",
  "Keep your arms level throughout — this is the part that makes the drill work.",
  "Make small, fast circles forward.",
  "Complete the target reps, keeping the arms up.",
  "Reverse and circle backward for the same count.",
  "Lower your arms to rest."],
 check:"If your arms are drifting below shoulder height as they tire, that's the drill telling you it's working — either hold them up through it or stop the set there rather than continuing with sagging arms."},

"single-arm-shrug":{desc:"Standing tall with arms relaxed, you shrug one shoulder straight up toward your ear at a time.",
 steps:["Stand tall with both arms relaxed at your sides.",
  "Keeping your torso completely still, shrug one shoulder straight up toward your ear.",
  "Hold briefly at the top.",
  "Lower back down under control.",
  "Complete the reps on that side, then switch.",
  "Notice whether one side feels stiffer or weaker than the other."],
 check:"If your torso is leaning toward the shrugging side, the movement has stopped being isolated — stand taller and let just the shoulder move."},

"wall-straddle-stack":{desc:"Facing the wall in a handstand, you open your legs into a straddle and use that lower centre of mass to actively push your hips into a stacked position over your shoulders.",
 steps:["Kick up into a chest-to-wall handstand.",
  "Open your legs out into a straddle — this lowers your centre of mass and makes the position easier to control.",
  "Actively push the floor away through your hands and shoulders.",
  "Drive your hips forward until they stack directly over your shoulders.",
  "Hold that stacked position for the target time, keeping the push active throughout.",
  "Come down under control."],
 check:"If your hips are sitting behind your shoulders in a banana shape rather than stacked over them, that's the exact thing this drill is meant to fix — push harder through the shoulders and drive the hips forward."},

"wall-straddle-snap":{desc:"Back to the wall with your hips touching it, you hold a straddle and then explosively snap your legs together into a full handstand.",
 steps:["Kick up with your back to the wall, bringing your hips into contact with it.",
  "Open your legs into a straddle position.",
  "Keeping your hips against the wall, snap your legs together explosively into a full straight handstand.",
  "Hold the closed position briefly.",
  "Reopen to the straddle under control.",
  "Repeat for the set."],
 check:"If your hips are drifting away from the wall as the legs close, you've changed the drill — reset against the wall so the closure stays isolated to the legs."},

"straddle-balance-snap":{desc:"You kick up into a straddle, push off the wall to find freestanding balance, then explosively close your legs into a straight handstand while balancing.",
 steps:["Kick up with your back to the wall into a straddle position.",
  "Push off the wall and find your balance in the straddle first.",
  "Once genuinely stable, snap your legs together into a straight handstand.",
  "Expect the balance to shift as the legs close — correct for it rather than fighting it.",
  "Hold the straight position as long as you can.",
  "Come down under control and repeat."],
 check:"If you're closing your legs as a way to save a failing balance rather than from a stable straddle, reset — the close should come from control, not panic."},
