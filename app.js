...
"handstand-kick-switch":{desc:"Facing a wall, you kick up into a handstand shape, briefly finding balance, then come back down leading with the opposite leg — repeating with alternating legs to build the coordination freestanding balance depends on.",
 steps:["Stand facing away from the wall, hands on the floor a comfortable kicking distance out.",
  "Kick up with one leg, driving through your hands and the kicking leg.",
  "Briefly find a balanced handstand shape, pausing for a moment if you can.",
  "Come back down leading with the opposite leg from the one that kicked up.",
  "Immediately kick up again, this time leading with the leg that just landed.",
